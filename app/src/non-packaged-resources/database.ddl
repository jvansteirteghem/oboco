...
create table bookMarkReferences (id bigint generated by default as identity, updateDate timestamp not null, userId bigint not null, bookId bigint, bookMarkId bigint not null, bookCollectionId bigint not null, rootBookCollectionId bigint not null, primary key (id));
